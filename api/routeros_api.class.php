 ...
 *
 ******************************/
include_once __DIR__ . '/../config_busca.php';

class RouterosAPI
{
    var $debug     = false; //  Show debug information
    var $connected = false; //  Connection state
    var $port      = PORT_API;  //  Port to connect to (default 8729 for ssl)
    ...
    public function connect($ip, $login, $password)
    {
        for ($ATTEMPT = 1; $ATTEMPT <= $this->attempts; $ATTEMPT++) {
            ...
            // $wait_time = $this->delay;

            // while ((microtime(true) - $start) < $wait_time) {
            //     // Pause
            // }
        }
